...
//
//===----------------------------------------------------------------------===//
#ifndef C_JWTKIT_BORINGSSL_SHIMS_H
#define C_JWTKIT_BORINGSSL_SHIMS_H
...
#if __has_include(<CJWTKitBoringSSL/CJWTKitBoringSSL.h>)
#include <CJWTKitBoringSSL/CJWTKitBoringSSL.h>
#else
#include <CJWTKitBoringSSL.h>
#endif
...
#endif  // C_JWTKIT_BORINGSSL_SHIMS_H
